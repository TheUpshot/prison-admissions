...
The [National Corrections Reporting Program](http://www.icpsr.umich.edu/icpsrweb/NACJD/series/38/studies/36373?archive=NACJD&sortBy=7) (NCRP) was the primary source for our analysis. We include summary data for calendar years 2006, 2013 and 2014. The Department of Justice limits access to the full dataset to those with an approved research exemption. 
...
We obtained data from five states – Arizona, Delaware, Kansas, New Mexico, Illinois – directly from state departments of corrections or sentencing commissions. The source of each row of data is noted in the `source` field.
